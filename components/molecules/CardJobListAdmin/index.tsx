...
const CardJobListAdmin = ({
    ...
    return (
        <div
            key={id}
            className=" rounded-lg p-6 bg-white cursor-pointer"
            onClick={handleClick}
            role="button"
            tabIndex={0}
            ...
            <div className="flex justify-between w-full">
                <div className="w-full space-y-2">
                    <div className="flex flex-col md:flex-row md:items-center gap-3 w-full">
                        <span
                            className={`inline-block px-4 py-1 border text-14 font-700 leading-24 rounded-lg w-fit ${
                                status === "active"
                        ...
                        <p className="text-14 font-400 leading-24 text-neutral-90 border border-neutral-40 py-1 px-4 rounded w-full md:w-auto md:flex-none">
                            {startedDate}
                        </p>
                    </div>
